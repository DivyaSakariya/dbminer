...
class _LibraryComponentState extends State<LibraryComponent> {
  final SwipeableCardsStackController _cardsController =
  ...
  Widget build(BuildContext context) {
    return SwipeableCardsStack(
      ...
      context: context,
      items: List.generate(
        dbQuoteController.fetchQuote.value.length,
        (index) => Card(
          child: Stack(
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(
                      quotesController.imageList[index]['urls']['regular'],
                    ),
                    fit: BoxFit.fill,
                  ),
                ),
              ...
              Align(
                ...
                child: Column(
                  ...
                  children: [
                    ListTile(
                      title: Text(
                        dbQuoteController.fetchQuote.value[index].quote!,
                        style: GoogleFonts.acme(
                          color: Colors.white,
                          letterSpacing: 1,
                          fontSize: 17,
                      ...
                      subtitle: Row(
                        ...
                        children: [
                          Text(
                            "- ${dbQuoteController.fetchQuote.value[index].author!}",
                            style: const TextStyle(color: Colors.white),
                          ),
                        ],
                      ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            dbQuoteController.deleteQuote(
                                id: dbQuoteController
                                    .fetchQuote.value[index].id);
                          },
                          icon: const Icon(
                            Icons.delete,
                            color: Colors.white,
